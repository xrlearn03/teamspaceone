  ...
  return (
    <SettingsSection title="Developer">
      <div className="max-w-lg space-y-3">
        ...
        {newToken ? <div className="flex gap-2"><Input readOnly value={newToken} /><Button variant="secondary" onClick={() => void navigator.clipboard.writeText(newToken)}>Copy</Button></div> : null}
