...
type Tab = "projects" | "tasks" | "milestones" | "files";
  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="mx-auto max-w-[1500px]">
        ...
        <PageHeader title="My Projects">
          {canRequestJoin ? (
            <Button onClick={() => setJoinDialogOpen(true)} className="h-10">
        ...
        <section className="mt-4 grid gap-4 lg:grid-cols-3">
          ...
          <UpcomingMilestonesPanel milestones={milestones.slice(0, 4)} projectMap={projectMap} onViewAll={() => setTab("milestones")} />
